...
- Storage beyond R2 (Drive + Hetzner): fully owned by Bayu, out of my queue
...
2. Hit `/api/storage/health` — R2 should stay green. Drive + Hetzner are Bayu's queue, not a blocker on this batch.
