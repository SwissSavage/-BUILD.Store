...
const KIND_ACCENT: Record<NotificationKind, string> = {
  ...
  milestone_due_important: "#D828A0",
  milestone_due_urgent: "#D828A0",
  milestone_overdue: "#D828A0",
  milestone_status_changed: "#5070F0",
  milestone_blocked: "#D828A0",
  project_weekly_rollup: "#5070F0",
  agreement_renewal_sixty_days: "#5070F0",
  agreement_renewal_thirty_days: "#5070F0",
  agreement_renewal_seven_days: "#D828A0",
