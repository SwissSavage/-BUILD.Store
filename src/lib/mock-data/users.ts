...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    ...
    secondaryIndustries: [],
    dataParticipation: false,
    skills: ["solidity", "erc-6551", "postgres", "typescript", "auth systems"],
    discipline: "Full-stack + Smart Contracts",
    profileMode: "contributor",
    bio: "Wrote the ERC-6551 primitive canonization runs on. Primary owner for production DB activation.",
    portfolioUrl: null,
    buildTokenBalance: "3400.00000000",
    isAdmin: false,
    talentTags: ["solidity", "erc-6551", "auth.js", "drizzle", "postgres"],
    avatarPortraitUrl: null,
    profilePublic: true,
    suspendedAt: null,
    suspensionReason: null,
    walletAddress: "0x6551000000000000000000000000000000000016",
    connectedWalletAddress: null,
    connectedWalletProvider: null,
    walletConnectedAt: null,
    stripeAccountId: null,
